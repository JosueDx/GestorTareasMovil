...
public class NuevaTarea extends Activity {
		...
		private String SOAP_ACTION2="http://192.168.71.53:8080/Servicio_Tarea/services/funciones_servicio/id_empleado";
		private String METODO2="id_empleado";
		
		private String SOAP_ACTION3="http://192.168.71.53:8080/Servicio_Tarea/services/funciones_servicio/id_nivel_tarea";
		private String METODO3="id_nivel_tarea";
	    
		private String SOAP_ACTION4="http://192.168.71.53:8080/Servicio_Tarea/services/funciones_servicio/lista_empleados";
		private String METODO4="lista_empleados";
	
		private String SOAP_ACTION5="http://192.168.71.53:8080/Servicio_Tarea/services/funciones_servicio/lista_niveltareas";
		private String METODO5="lista_niveltareas";
		
		private String SOAP_ACTION6="http://192.168.71.53:8080/Servicio_Tarea/services/funciones_servicio/id_empleado";
		private String METODO6="id_empleado";
		
		private String SOAP_ACTION7="http://192.168.71.53:8080/Servicio_Tarea/services/funciones_servicio/actualizartarea";
		private String METODO7="actualizartarea";
		
		private String SOAP_ACTION8="http://192.168.71.53:8080/Servicio_Tarea/services/funciones_servicio/eliminartarea";
		...
		if(opcionInt==2){
			...
			if(opcionInt==3){
				...
				if(opcionInt==4){
					...
					edittextComentario.setText(tobj.getComentario());
					edittextComentario.setHintTextColor(getResources().getColor(R.color.abc_search_url_text_normal));
 					edittextDescripcion.setHintTextColor(getResources().getColor(R.color.abc_search_url_text_pressed));
					edittextDescripcion.setText(tobj.getDescripcion());
					String fe1 = CapturarFechaInicio(tobj.getFecha_inicio());
					btnFechaInicio.setText(fe1);
					String ho1= CapturarHoraInicio(tobj.getFecha_inicio());
