...
public class CustomListViewEficiencia extends ArrayAdapter<Tarea>{

	Context context;
	
	 public CustomListViewEficiencia(Context context, int resourceId,
	            List<Tarea> items) {
	 ...
	 // aqui inflamos el layout normal de un adapter es decir 
	        ...
	        if (convertView == null) {
	            ...
	            convertView = mInflater.inflate(R.layout.eficiencia_list, null);
